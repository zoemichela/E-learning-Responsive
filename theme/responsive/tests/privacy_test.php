...
/**
 * Privacy tests for theme_responsive.
 *
...
use \theme_responsive\privacy\provider;

/**
 * Unit tests for theme_responsive/classes/privacy/policy
 *
 * @copyright  2018 Adrian Greeve <adriangreeve.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_responsive_privacy_testcase extends \core_privacy\tests\provider_testcase {
    ...
    public function test_export_user_preferences() {
        ...
        $exportedpreferences = $writer->get_user_preferences('theme_responsive');
        $this->assertCount(1, (array) $exportedpreferences);
        $this->assertEquals('false', $exportedpreferences->{provider::DRAWER_OPEN_NAV}->value);
        $this->assertEquals(get_string('privacy:drawernavclosed', 'theme_responsive'),
        ...
        $this->assertEquals(get_string('privacy:drawernavopen', 'theme_responsive'),
                $exportedpreferences->{provider::DRAWER_OPEN_NAV}->description);
    }
}
